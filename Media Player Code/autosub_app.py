#!c:\users\akki\anaconda2\envs\py36\python.exe
import argparse
import audioop
...
from progressbar import progressbar, Percentage, Bar, ETA, ProgressBar
...
def main_sub(parser,src,des):
    parser.add_argument('-S', '--src-language', help="Language spoken in source file", default=src)
    parser.add_argument('-D', '--dst-language', help="Desired language for the subtitles", default=des)
